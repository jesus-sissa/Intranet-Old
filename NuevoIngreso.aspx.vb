...
Partial Public Class NuevoIngreso
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call LlenarLista()
        'Call MuestraGridVacios()'28/11/2012 desactivado
    ...
    Sub LlenarMasDatos()
        ...
        'pero como que no se deja atte. Nuncio
        '------------------------------------------------------------------
    End Sub
    ...
    Private Sub LlenarLista()
        ...
        dt = fn_Default_GetEmpleados(Session("SucursalID"), Session("UsuarioId"), "S")
    ...
    Private Function Validar() As Boolean
        ...
        If tbx_Contrasena.Text = "" Then
            ...
            Return False
        End If
        If tbx_Contrasena.Text.Length < 4 Then
            MostrarAlertAjax("Contraseña Incorrecta.", btn_Aceptar, Page)
            tbx_Contrasena.Focus()
            Return False
        End If
        If Not FuncionesGlobales.fn_Valida_Cadena(tbx_Contrasena.Text, FuncionesGlobales.Validar_Cadena.LetrasNumerosYCar) Then
        ...
        If tbl IsNot Nothing AndAlso tbl.Rows.Count > 0 Then
            Dim PasswordUsr As String = FormsAuthentication.HashPasswordForStoringInConfigFile(tbx_Contrasena.Text, "SHA1")
            ...
            If PasswordUsr = tbl.Rows(0).Item("Password") Then
                Return True
            Else
