...
Partial Public Class wuc_Empleados
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Page.Title = "CONSULTA DE EMPLEADOS"
        ...
        For x As Integer = 0 To arr.Length - 1
            If arr(x) = "CONSULTA DE EMPLEADOS" Then
                Exit For
    ...
    Protected Sub dgv_Empleados_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles dgv_Empleados.PageIndexChanging
        ...
        If Session("Dpto_Reclutamiento") = Session("DepartamentoId") Then
            dgv_Empleados.DataSource = fn_Default_GetEmpleados(Session("SucursalID"), 0, "N", Session("UsuarioID"))
        Else
            dgv_Empleados.DataSource = fn_Default_GetEmpleados(Session("SucursalID"), Session("DepartamentoID"), "N", Session("UsuarioID"))
        End If
        dgv_Empleados.DataBind()
    End Sub
