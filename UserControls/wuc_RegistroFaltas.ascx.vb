...
Partial Class wuc_RegistroFaltas
    ...
    Protected Sub btn_Guardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        If gv_Jornadas.DataKeys(0).Values("Id_Jornada").ToString = "" Then
            MostrarAlertAjax("No hay Jornadas en la lista.", btn_Guardar, Page)
            Exit Sub
        End If
        ...
        If cant = 0 Then
            MostrarAlertAjax("No se ha marcado ningún registro.", btn_Guardar, Page)
            Exit Sub
        End If
        If Not fn_Faltas_Guardar(Session("SucursalID"), Session("UsuarioID"), "", Faltas) Then
            MostrarAlertAjax("Ha ocurrido un error al intentar eliminar el Día.", btn_Guardar, Page)
        End If
    End Sub
