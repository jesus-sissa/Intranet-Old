<%@ Control Language="VB" AutoEventWireup="false"
    Inherits="SISSAIntranet.UserControls_wuc_NuevoIngreso" Debug="true" Codebehind="wuc_NuevoIngreso.ascx.vb" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<link href="../Estilos/StyleSheet.css" rel="stylesheet" type="text/css" />
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1">
    <title>Validar Nuevo Ingreso</title>
    <style type="text/css">
        #Radio1
        {
            width: 135px;
...
<body>
    ...
    <%--<br />
    <div id="divEnca">
        <strong>Validar Nuevo Ingreso</strong>
    </div>--%>
    <div id="div1">
    ...
    <div id="div3">
        <br />
        <ajax:TabContainer ID="tbc_Datos" runat="server" ActiveTabIndex="0" Width="100%"
            ...
            <asp:Panel ID="pnl_Firma" runat="server" ForeColor="Black" Visible="True" Width="520px"
                ...
                <table class="tablaSISSA1">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:Label runat="server" Text="Nota: Al firmar electronicamente a traves de INTRANET SIAC, según las políticas de SISSA, dicha firma cuenta con la misma validez, que una firma manuscrita."></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
